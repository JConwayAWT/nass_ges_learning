...
training_labels = np.loadtxt("head_on_accidents_labels_fatal_or_incapacitating_fit.txt")
testing_data = np.loadtxt("head_on_accidents_without_severity_test.txt")
testing_labels = np.loadtxt("head_on_accidents_labels_fatal_or_incapacitating_test.txt")
